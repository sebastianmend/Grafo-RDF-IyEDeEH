...
DATA = BASE_DIR / "notebooks/data/processed"
OUT = BASE_DIR / "notebooks/out"
OUT.mkdir(parents=True, exist_ok=True)

print(f"📂 Directorio de datos: {DATA}")
print(f"📂 Directorio de salida: {OUT}")

if not DATA.exists():
    print(f"❌ Error: No se encuentra el directorio de datos en {DATA}")
    sys.exit(1)
